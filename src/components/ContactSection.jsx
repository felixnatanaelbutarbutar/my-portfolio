...
const ContactSection = () => {
  ...
  const socialMedia = [
    ...
    },
    {
      ...
      href: "https://twitter.com/felixfbi_", // Ganti dengan username Twitter Anda
      color: "#1DA1F2",
      username: "@felixfbi_"
    }
  ];
        ...
        <div className="cta-section">
          <div className="cta-card">
            ...
            <div className="cta-buttons">
              <a href="mailto:felixnatb@gmail.com" className="cta-button primary">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                  <polyline points="22,6 12,13 2,6"></polyline>
                </svg>
              ...
              <a href="https://wa.me/6285142232595" target="_blank" rel="noopener noreferrer" className="cta-button secondary">
